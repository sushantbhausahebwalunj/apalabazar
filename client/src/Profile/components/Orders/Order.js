...
const sharedClasses = {
  ...
  card: "bg-white p-4 rounded-xl m-5 border",
  image: "w-20 h-20 object-cover rounded-lg mr-4",
  text: "text-md md:text-lg font-semibold",
  info: "text-zinc-600",
  status: "text-sm",
};
    ...
    <div className={sharedClasses.card}>
      <div className="flex flex-col sm:flex-row items-center">
        ...
        <div className="flex-grow mt-4 sm:mt-0">
          ...
          <p className="bg-green-200 p-2 text-xs rounded">
...
const Orders = () => {
  return (
    <div className="p-4">
      <div className="mx-auto  bg-white p-4 rounded-md shadow h-[80vh] overflow-scroll sidebar">
        <div className="flex flex-col p-5  sm:flex-row gap-2 mt-5 items-center mb-4 w-full">
          <input
            type="text"
            placeholder="Search your orders here"
            className={`${sharedClasses.input} bg-gray-100 p-2 border rounded-xl w-full sm:w-[70%]`}
          />
          <button className={`${sharedClasses.button} p-2 px-4 w-full sm:w-fit`}>
            <svg
        ...
        <div className="space-y-5">
          <OrderItem
            ...
            price="261"
            color="White Size: 8"
            status={{ color: "text-green-500", text: "● Refund Completed" }}
