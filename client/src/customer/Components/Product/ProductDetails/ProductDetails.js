        ...
        <div className='rounded-3xl bg-gradient-to-br from-violet-500 to-orange-300'>
          <div className='flex flex-col shadow-lg backdrop-blur-sm bg-white/60 rounded-3xl lg:flex-row items-center justify-center'>
            <div className='w-[299px] my-6 lg:my-0 -translate-y-5 mx-12 '>
              <Slider {...settings}>
                {productData.productImg && productData.productImg.map((image, i) => (
                  <div key={i}>
              ...
              <div className='rounded-lg p-2'>
                <div className='w-80'>
                  ...
                  <div className='flex gap-2'>
                    <div className='flex gap-2 text-gray-400 bg-gray-200 rounded-lg items-center px-2'><p>MRP</p> <span className='line-through'>{productData.mrp}</span></div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-move-right"><path d="M18 8L22 12L18 16"/><path d="M2 12H22"/></svg>
...
function StarIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="orange" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-star">
