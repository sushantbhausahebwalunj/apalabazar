        ...
        <div className="rounded-3xl bg-gradient-to-br from-violet-500 to-orange-300">
          <div className="flex flex-col shadow-lg backdrop-blur-sm bg-white/60 rounded-3xl lg:flex-row items-center justify-center">
            ...
            <div className="w-80 p-2 backdrop-blur-xl pl-8 z-10 relative">
              ...
              <h2 className="font-semibold text-2xl mb-4 font-thin">
              ...
              <div className="rounded-lg p-2">
                <div className="w-80">
                  ...
                  <div className="rounded-lg p-2 border my-2 border-black">
                    ...
                    <button className="p-1 bg-green-100 rounded-lg w-24 my-2 text-green-700 border border-green-700">
                  ...
                  <div className="flex hover:scale-[103%] transition-all justify-between my-6 p-[2px] w-fit rounded-lg bg-gradient-to-br from-violet-500 to-orange-300">
                    <button
                      ...
                      className="bg-gradient-to-b from-violet-100 to-orange-100 border w-32 text-black p-2 rounded-lg"
                    >
                      Add to Cart
                    </button>
                  </div>
                  <div className="flex justify-between my-6 rounded-md">
                    <button className="bg-green-100 text-green-600 p-2 rounded-md">
              ...
              <div className="lg:w-[700px] min-h-screen w-full mx-auto font-mono">
                {tab === "Description" && (
                  <textarea
                    rows={productData.description.length > 900 ? 40 : 30}
                    readOnly={true}
                    className="h-fit text-lg outline-none mx-auto mt-12 w-full lg:w-[70vw]"
                  >
                    {productData.description}
                  </textarea>
                )}
                {tab === "Disclaimer" && (
                  <p className="mt-12 lg:w-[70vw] w-full">
                    While we work to ensure that the product information is
                    correct, actual product packaging and material may contain
                    more or different information from what is given here.
                    Please read the product labels, description, directions,
                    warning and other information that comes with the actual
                    product before use.
                  </p>
                )}
