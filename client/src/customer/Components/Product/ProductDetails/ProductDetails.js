          ...
          {tab === "Disclaimer" && (
            <div className='w-[80vw] rounded-lg overflow-hidden p-6'>
              ...
              <div className='text-gray-700'>
                ...
                <p className='mb-4'>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of www.flipkart.com website.</p>
          ...
          {tab === "Country of Origin" && (
            <div className='max-w-sm mx-auto bg-white shadow-md rounded-lg overflow-hidden p-4'>
              ...
              <p className='text-gray-700'>
                <span className='font-semibold'>Address:</span> 123 Main Street, Pune City, India 220223
              </p>
            </div>
          )}
          {tab === "Reviews" && <Reviews />}
